; $ID:	ILLEX_VIEWER_IMAGE.PRO,	2022-08-08-09,	USER-KJWH	$
  FUNCTION ILLEX_VIEWER_IMAGE, VERSTR, FILE=FILE, MAPP=MAPP, BUFFER=BUFFER, CURRENT=CURRENT, $
                               ...
                               PROD_SCALE=PROD_SCALE, CBTITLE=CBTITLE, SCLR=SCLR, PAL=PAL, _EXTRA=EXTRA
...
; ****************************************************************************************************
  ...
  CASE MP OF
    'MAB': BEGIN & DB_BKG = 'WHITE' & DB_POS=[0,0.95,1,1] & CB_POS=[POS[0]+0.02,POS[3]-.1,0.44,POS[3]-0.08] & TITLE_POS=[0.5,0.97] & END
    ELSE:  BEGIN & DB_BKG = [] & DB_POS=[POS[0],POS[3],POS[2],0.99] & CB_POS=[POS[0]+0.035,POS[3]-.065,0.5,POS[3]-0.045] & END
  ENDCASE
  ...
  IF KEYWORD_SET(ADD_TITLE) THEN TXT = TEXT(TITLE_POS[0],TITLE_POS[1],TITLE_TEXT,ALIGNMENT=0.50,FONT_SIZE=16)
