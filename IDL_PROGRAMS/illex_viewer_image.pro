; $ID:	ILLEX_VIEWER_IMAGE.PRO,	2024-01-30-21,	USER-KJWH	$
  FUNCTION ILLEX_VIEWER_IMAGE, VERSTR, FILE=FILE, DATERANGE=DATERANGE,MAPP=MAPP, BUFFER=BUFFER, CURRENT=CURRENT, $
                               ...
                               RESIZE=RESIZE, ADD_BORDER=ADD_BORDER, ADD_COLORBAR=ADD_COLORBAR, ADD_DATEBAR=ADD_DATEBAR, ADD_PIONEER=ADD_PIONEER,$
...
; ****************************************************************************************************
  ...
  IF KEYWORD_SET(ADD_BORDER) THEN BOXI = POLYLINE(BX,BY,THICK=5,COLOR='BLACK',TARGET=IMG)
