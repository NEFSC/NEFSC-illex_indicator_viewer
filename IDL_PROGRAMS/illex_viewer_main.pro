; $ID:	ILLEX_VIEWER_MAIN.PRO,	2022-08-08-09,	USER-KJWH	$
  PRO ILLEX_VIEWER_MAIN, VERSION, RESOLUTION=RESOLUTION, BUFFER=BUFFER, VERBOSE=VERBOSE, OVERWRITE=OVERWRITE, $
...
;      BATCH_L3, DO_STATS='Y_2020_2022[GLOBCOLOUR;P=PICO_PERCENTAGE-TURNER;PER=M;M=L3B4]'
    ...
    IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN
      ILLEX_VIEWER_COMPOSITE, VERSTR, /WEEKS, BUFFER=1,$
...
;      ENDFOR
    ...
    IF KEYWORD_SET(SST_ANIMATION) THEN BEGIN
      ILLEX_VIEWER_SST_ANIMATION, VERSTR, MAPP=MAPP, BUFFER=1, /ADD_CONTOURS, /ADD_COLORBAR, /ADD_DATEBAR, /ADD_BATHY, /ADD_LONLAT, /ADD_BOARDER, OUTCOLOR=0
    ENDIF ; SST_ANIMATION
