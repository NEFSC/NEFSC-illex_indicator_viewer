    ...
    ENDIF
     ...
     IF KEYWORD_SET(DO_FRONTS) THEN BEGIN
       FOR F=0, N_ELEMENTS(VERSTR.INFO.FRONT_PRODS)-1 DO BEGIN
         ...
         STACKED_MAKE_FRONTS_WRAPPER, PSTR.DATASET,      DATERANGE=DR, /DO_FRONTS, /DO_FRONT_NETCDF;, /DO_STATS, /DO_STAT_NETCDF, STAT_PERIODS=['D3','D8','W','M'], OVERWRITE=OVERWRITE
         STACKED_MAKE_FRONTS_WRAPPER, PSTR.TEMP_DATASET, DATERANGE=DR, /DO_FRONTS, /DO_FRONT_NETCDF;, /DO_STATS, /DO_STAT_NETCDF, STAT_PERIODS=['D3','D8','W','M'], OVERWRITE=OVERWRITE
       ENDFOR  
     ENDIF
