  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    ENDIF
     ...
     IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN 
       ...
       ; Weekly
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2023,2026],PRODS=['SST','CHLOR_A'],/WEEKS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'SST_CHL_COMPOSITES'+SL
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2023,2026],PRODS=['SST'],/WEEKS,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'SST_COMPOSITES'+SL
...
;       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, YEARS=['2022','2023','2024'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'YEAR_COMPOSITES_2022_2024'+SL
       ...
       ; Monthly
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2023,2026],PRODS=['SST','CHLOR_A'],/MONTHS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1, DIR_OUT=DIRM+'SST_CHL_COMPOSITES'+SL
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2023,2026],PRODS=['SST'],/MONTHS,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRM + 'SST_COMPOSITES'+SL
