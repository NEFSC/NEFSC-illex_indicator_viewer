...
; ****************************************************************************************************
  ...
  IF ~N_ELEMENTS(SUBAREA_EXTRACTS)    THEN SUBAREA_EXTRACTS = 'Y'
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF KEYWORD_SET(SST_ANIMATION) THEN ILLEX_VIEWER_SST_ANIMATION, VERSTR, MAPP=MAPP, BUFFER=BUFFER, /ADD_CONTOURS, /ADD_COLORBAR, /ADD_DATEBAR, /ADD_BATHY, /ADD_LONLAT, /ADD_BOARDER;, OUTCOLOR=0  
    ...
    IF KEYWORD_SET(SUBAREA_EXTRACTS) THEN BEGIN
      ILLEX_SUBAREA_EXTRACT, VERSTR,PERIOD=['W','WEEK','M','MONTH'],FILETYPE=['STATS','ANOMS']
      ILLEX_SUBAREA_PLOTS
    ENDIF
