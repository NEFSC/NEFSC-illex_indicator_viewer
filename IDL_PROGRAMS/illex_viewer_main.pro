...
; ****************************************************************************************************
  ...
  IF ~N_ELEMENTS(ANIMATIONS)          THEN ANIMATIONS       = 'Y'
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF KEYWORD_SET(LOGFILE) AND LUN EQ [] THEN BEGIN
      LOGDIR = DIR_PROJECT + 'IDL_OUTPUTS' + SL + 'LOGS' + SL & DIR_TEST, LOGDIR
    ...
    IF KEYWORD_SET(PROCESS_FILES) THEN BEGIN ;ILLEX_WEEKLY_PROCESSING, VERSTR
      ...
      FOR N=0, N_ELEMENTS(PRODS)-1 DO BEGIN
        ...
        DSET = PSTR.DATASET
        PRINT, "Processing files for " + DSET
        IF STRUCT_HAS(PSTR,'TEMP_DATASET') THEN BEGIN & TSET = PSTR.TEMP_DATASET & TPERS = VERSTR.INFO.STAT_TEMP_PERIODS & ENDIF ELSE TSET = []
        FILES_2STACKED_WRAPPER, DSET, PRODS=PSTR.PROD,DATERANGE=DR                                            & IF TSET NE [] THEN FILES_2STACKED_WRAPPER, TSET, PRODS=PSTR.TEMP_PROD,DATERANGE=DR
        STACKED_STATS_WRAPPER, DSET, PRODS=PSTR.PROD, PERIODS=VERSTR.INFO.STAT_PERIODS                        & IF TSET NE [] THEN STACKED_STATS_WRAPPER, TSET, PRODS=PSTR.TEMP_PROD, PERIODS=TPERS
        STACKED_ANOMS_WRAPPER, DSET, PRODS=PSTR.PROD, PERIODS=VERSTR.INFO.ANOM_PERIODS                        & IF TSET NE [] THEN STACKED_ANOMS_WRAPPER, TSET, PRODS=PSTR.TEMP_PROD, PERIODS=TPERS
    ...
    ENDIF
     ...
     IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN 
       ; Directories
       DIRM=VERSTR.DIRS.DIR_COMPOSITES + 'MONTHLY' + SL
       DIRW=VERSTR.DIRS.DIR_COMPOSITES + 'WEEKLY' + SL
       
       ; Weekly
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2026],PRODS=['SST','CHLOR_A'],/WEEKS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'SST_CHL_COMPOSITES'+SL
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2026],PRODS=['SST'],/WEEKS,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'SST_COMPOSITES'+SL
       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, YEARS=['2022','2023','2024','2025','2026'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'YEAR_COMPOSITES_2022_2026'+SL
;       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, YEARS=['2022','2023','2024','2025'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'YEAR_COMPOSITES_2022_2025'+SL
;       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, YEARS=['2022','2023','2024'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRW+'YEAR_COMPOSITES_2022_2024'+SL

       
       ; Monthly
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2026],PRODS=['SST','CHLOR_A'],/MONTHS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1, DIR_OUT=DIRM+'SST_CHL_COMPOSITES'+SL
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2026],PRODS=['SST'],/MONTHS,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRM + 'SST_COMPOSITES'+SL
       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /MONTHS, YEARS=['2022','2023','2024','2025','2026'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT= DIRM+'YEAR_COMPOSITES_2022_2026'+SL
;       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /MONTHS, YEARS=['2022','2023','2024','2025'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRM+'YEAR_COMPOSITES_2022_2025'+SL
;       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /MONTHS, YEARS=['2022','2023','2024'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=DIRM+'YEAR_COMPOSITES_2022_2024'+SL
