...
;          SPROD=PSTR.ANOM_SCALE, PAL = PSTR.ANOM_PAL,  DIR_OUT=VERSTR.DIRS.DIR_PNGS+PSTR.PROD+SL, OVERWRITE=OVERWRITE, _EXTRA=_EXTRA  
 ...
 ;       STACKED_2NETCDF_WRAPPER, DSET,PRODS=PSTR.PROD,PERIODS=VERSTR.INFO.NETCDF_PERIODS, DATERANGE=DR
    ...
    IF KEYWORD_SET(MAKE_COMPOSITES) THEN ILLEX_VIEWER_COMPOSITE, VERSTR, /WEEKS, BUFFER=0,OUTLINE=CANYON_OUTLINES, OUT_COLOR=0, /ADD_BATHY, /ADD_LONLAT, /ADD_COLORBAR, ADD_PIONEER=0, /ADD_BOARDER
 stop     
