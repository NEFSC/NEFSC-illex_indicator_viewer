  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    ENDIF
     ...
     IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN 
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[1998,2025],PRODS=['SST','CHLOR_A'],/MONTHS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1
       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /MONTHS, YEARS=['2022','2023','2024','2025'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=VERSTR.DIRS.DIR_COMPOSITES + 'YEAR_COMPOSITES' + SL

       
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[20250801,20251231],PRODS=['SST','CHLOR_A'],/WEEKS,/MONTHS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1
       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, /MONTHS, YEARS=['2022','2023','2024','2025'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,DATE_POS=[0.9,0.1],DATE_ALIGN=1.0,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=VERSTR.DIRS.DIR_COMPOSITES + 'YEAR_COMPOSITES' + SL
