  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    ENDIF
     ...
     IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN 
       PROJECT_MAKE_COMPOSITE, VERSTR, DATERANGE=[2025],PRODS=['SST','CHLOR_A'],/MONTHS,OUTLINE=CANYON_OUTLINES,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1
