  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF KEYWORD_SET(PROCESS_FILES) THEN BEGIN ;ILLEX_WEEKLY_PROCESSING, VERSTR
      ...
      FOR N=0, N_ELEMENTS(PRODS)-1 DO BEGIN
        ...
        STACKED_STATS_WRAPPER, DSET, PRODS=PSTR.PROD, PERIODS=VERSTR.INFO.STAT_PERIODS                        & IF TSET NE [] THEN STACKED_STATS_WRAPPER, TSET, PRODS=PSTR.PROD, PERIODS=VERSTR.INFO.STAT_TEMP_PERIODS
        STACKED_ANOMS_WRAPPER, DSET, PRODS=PSTR.PROD, PERIODS=VERSTR.INFO.ANOM_PERIODS                        & IF TSET NE [] THEN STACKED_ANOMS_WRAPPER, TSET, PRODS=PSTR.PROD, PERIODS=VERSTR.INFO.ANOM_TEMP_PERIODS
    ...
    ENDIF
     ...
     IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN 
       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, YEARS=['2022','2023','2024'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADDDATE,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=1,DIR_OUT=VERSTR.DIRS.DIR_COMPOSITES + 'YEAR_COMPOSITES' + SL
