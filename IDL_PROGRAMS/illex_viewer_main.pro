  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    ENDIF
     ...
     IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN 
       PROJECT_MAKE_COMPOSITE, VERSTR, PRODS=['SST'], /WEEKS, YEARS=['2022','2023','2024'],TYPES=['STACKED_STATS','STACKED_ANOMS'],/YEAR_COMBO,/ADD_LONLAT,/ADD_COLORBAR,/ADD_BATHY,/ADD_BORDER,OUT_COLOR=0,BUFFER=0
