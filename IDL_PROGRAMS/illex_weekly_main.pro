...
; ****************************************************************************************************
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF KEYWORD_SET(PROCESS_FILES) THEN BEGIN ;ILLEX_WEEKLY_PROCESSING, VERSTR
      BATCH_L3, DO_GHRSST='Y[MUR;M=L3B2.L3B4]',DO_STATS='Y_2020_2022[MUR;PER=W.M]',DO_ANOMS='Y_2022[MUR;PER=WM]',DO_FRONTS='Y[MUR;M=L3B2]'
      BATCH_L3, DO_GLOBCOLOUR='Y',DO_MAKE_PRODS='Y_2020_2022[GLOBCOLOUR]',DO_STATS='Y_2020_2022[GLOBCOLOUR;P=CHLOR_A-GSM;PER=W.M;M=L3B4]',DO_ANOMS='Y_2022[GLOBCOLOUR;P=CHLOR_A-GSM;PER=WM]', DO_FRONTS='Y[GLOBCOLOUR]'     
      BATCH_L3, DO_STATS='Y_2020_2022[GLOBCOLOUR;P=MICRO-TURNER.NANO-TURNER.PICO-TURNER.MICRO_PERCENTAGE-TURNER.NANO_PERCENTAGE-TURNER.PICO_PERCENTAGE-TURNER;PER=M;M=L3B4]'
