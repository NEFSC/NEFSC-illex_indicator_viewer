...
;      BATCH_L3, DO_STATS='Y_2020_2022[GLOBCOLOUR;P=PICO_PERCENTAGE-TURNER;PER=M;M=L3B4]'
    ...
    IF KEYWORD_SET(EVENTS) THEN BEGIN
      ILLEX_WEEKLY_EVENTS, 'WCR_20210608', BUFFER=0

      ILLEX_WEEKLY_EVENTS, 'UPWELLING_202207', BUFFER=1
      ILLEX_WEEKLY_EVENTS, 'SMALL_SQUID_202207', BUFFER=1
    ...
    IF KEYWORD_SET(MAKE_COMPOSITES) THEN BEGIN
      ILLEX_WEEKLY_COMPOSITE, VERSTR, /WEEKS, BUFFER=1,$
        OUTLINE=CANYON_OUTLINES, OUT_COLOR=0, /ADD_BATHY, /ADD_LONLAT, /ADD_COLORBAR, /ADD_PIONEER, /ADD_BOARDER
    ENDIF ; COMPOSITE
