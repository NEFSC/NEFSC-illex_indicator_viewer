  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    CASE VER OF
      'V2022': BEGIN                                                                                ; V2022 specific information
        ...
        PRODS = ['BATHY','CHLOR_A','SST','GRAD_CHL','GRAD_SST','SEALEVEL','OCEAN','MICRO','NANO','PICO',['MICRO','NANO','PICO']+'_PERCENTAGE']
    ...
    FOR P=0, N_ELEMENTS(PRODS)-1 DO BEGIN
      ...
      CASE SPROD OF
        ...
        'BATHY':    BEGIN & DTSET='' & TPSET='' & SPROD='BATHY' & DWLPROD='' & PTAG='' & PSCALE='BATHY_1_5000' & PAL='PAL_OCEAN' & ASCALE='' & APAL='' & END
      ENDCASE ; SPROD
