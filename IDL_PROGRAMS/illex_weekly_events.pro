...
; ****************************************************************************************************
  ...
  FOR E=0, N_ELEMENTS(EVENTS)-1 DO BEGIN
    ...
    IF VER NE VERSION THEN VERSTR = ILLEX_WEEKLY_VERSION(VERSION) ; Reread the VERSION structure if different from the default
      ...
      FOR N=0, N_ELEMENTS(PRODS)-1 DO BEGIN
        ...
        FOR T=0, N_ELEMENTS(TYPES)-1 DO BEGIN
          ...
          IMG = ILLEX_WEEKLY_IMAGE(VERSTR, FILE=FILE, BUFFER=BUFFER, MAPP=MP, OUTLINE=ECANYON_OUTLINES, OUT_COLOR=40, OUT_THICK=2, $
            ...
            /ADD_BATHY, ADD_LONLAT=ADD_LONLAT, PROD_SCALE=PROD_SCALE, CBTITLE=CBTITLE, SCLR=SCLR, PAL=PAL, LONS=LONS, LATS=LATS,$
            RESIZE=RESIZE,/ADD_COLORBAR, ADD_PIONEER=ADD_PIONEER,/ADD_BOARDER,/ADD_TITLE,TITLE_TEXT=TXT)
    ...
    IF KEYWORD_SET(MAKE_COMPOSITE) OR KEYWORD_SET(MAKE_ANIM_COMP) THEN BEGIN
      ILLEX_WEEKLY_COMPOSITE, VERSTR, PRODS=PRODS, /WEEKS, /DAYS, MAPP=MP, BUFFER=BUFFER, DATERANGE=DATERANGE, DIR_OUT=DIR_OUT,$
        OUTLINE=ECANYON_OUTLINES, OUT_COLOR=OUT_COLOR, ADD_BATHY=ADD_BATHY, ADD_LONLAT=ADD_LONLAT, LONS=LONS, LATS=LATS,$
        RESIZE=RESIZE,/ADD_COLORBAR, ADD_PIONEER=ADD_PIONEER,/ADD_BOARDER
