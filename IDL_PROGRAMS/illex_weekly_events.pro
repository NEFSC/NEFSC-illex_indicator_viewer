    ...
    FOR W=0, N_ELEMENTS(WEEKS)-1 DO BEGIN
      ...
      FOR N=0, N_ELEMENTS(PRODS)-1 DO BEGIN
        ...
        FOR T=0, N_ELEMENTS(TYPES)-1 DO BEGIN
          ...
          IMG = ILLEX_WEEKLY_IMAGE(VERSTR, FILE=FILE, BUFFER=BUFFER, MAPP=MP, OUTLINE=ECANYON_OUTLINES, OUT_COLOR=10, OUT_THICK=2, $
            /ADD_POINTS, PLONS=FLONS, PLATS=FLATS, PSYM='STAR', PCOLOR='NAVY', PSIZE=2, $
            /ADD_BATHY, /ADD_LONLAT, PROD_SCALE=PROD_SCALE, CBTITLE=CBTITLE, SCLR=SCLR, PAL=PAL, LONS=LONS, LATS=LATS,$
            RESIZE=RESIZE,/ADD_COLORBAR, /ADD_PIONEER,/ADD_BOARDER,/ADD_TITLE,TITLE_TEXT=TXT,TITLE_POS=[0.5,0.05])
