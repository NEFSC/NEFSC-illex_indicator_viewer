...
; ****************************************************************************************************
  ...
  FOR N=0, N_ELEMENTS(PRODS)-1 DO BEGIN
    ...
    CASE DSET OF
      'GLOBCOLOUR': BEGIN
        DWLD_GLOBCOLOUR, DATERANGE=DTR, PRODS=[DPROD,'PAR']
        DWLD_GLOBCOLOUR, DATERANGE=DTR, PRODS=[DPROD,'PAR'],/GETMAPPED
      END  
      'MUR':  DWLD_MUR_SST,DATERANGE=DTR 
      'CMES': DWLD_CMES,DPROD,DATERANGE=DTR
      'ACSPONRT': BEGIN
        DWLD_ACSPO_SST, DATERANGE=DTR, DATASETS='NRT' 
        DWLD_ACSPO_SST 
        DWLD_MUR_SST,DATERANGE=DTR ; Temporarily also download MUR data (for the 2026 SOE processing)
      END  
    ENDCASE
